...
const categoryTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'Family & Business Visas': 'Family & Business Visas',
    'Tourist Visa Extension Services': 'Tourist Visa Extension',
    'License Renewal Services': 'License Renewals',
  ...
  ar: {
    ...
    'Family & Business Visas': 'تأشيرات العائلة والأعمال',
    'Tourist Visa Extension Services': 'تجديد التأشيرات السياحية',
    'License Renewal Services': 'تجديد الرخص تجارية',
    'Car Rental Services': 'تأجير السيارات',
