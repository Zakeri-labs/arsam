  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#07111f] font-sans text-right text-white" dir="rtl">
      ...
      <div className="flex min-h-dvh w-full max-w-full overflow-x-hidden">
        ...
        <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:right-0 md:top-0 md:h-dvh md:z-20 border-l border-white/10 bg-[#0b172a] shadow-2xl">
          <SidebarContent />
        </aside>
        ...
        {/* MAIN DISPLAY AREA */}
        <div className="flex-1 min-w-0 w-full max-w-full md:mr-64 min-h-dvh flex flex-col bg-[#07111f] overflow-x-hidden">
