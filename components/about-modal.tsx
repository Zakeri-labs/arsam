...
const aboutContent: Record<Language, AboutContent> = {
  en: {
    ...
    p3: 'At ABU ARSAM, our ultimate goal is to let you focus on growing your business instead of getting caught up in administrative, legal, and tax complexities. We handle the rest of the journey with precision, dedication, and expertise.',
    whyHeader: 'Why ABU ARSAM?',
  ...
  fa: {
    ...
    p3: 'در ابوآرسام هدف ما این است که شما به جای درگیر شدن با پیچیدگی‌های اداری، قانونی و مالیاتی، روی رشد کسب‌وکار خود تمرکز کنید. باقی مسیر را ما با دقت، پیگیری و تجربه جلو می‌بریم.',
    whyHeader: 'چرا ابوآرسام؟',
  ...
  ar: {
    ...
    p3: 'في ابوآرسام، هدفنا هو تمكينك من التركيز على نمو أعمالك بدلاً من الانشغال بالتعقيدات الإدارية، القانونية، والضريبية. نحن نتولى بقية المسار بدقة، متابعة مستمرة، وخبرة واسعة.',
    whyHeader: 'لماذا ابوآرسام؟',
